...
export const EasyBankLogo = ({ color }) => {
  return (
    //todo you must do it with SvgIcon
    // <SvgIcon {...props}>
...
export const BGIntroDesktop = () => {
  return (
    //! it was not possible to use SvgIcon
    //!so without SvgIcon you must change attribute for react
    // <SvgIcon {...props}>
    <svg
